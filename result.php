...
.card:hover h2{ font-size: 18px; color:   #c68642 ; }
		...
		<body>
			...
			<h1>Get Homework
				...
				<p >
			To see the added homework/Assignment click below
			</p>
			<a href="result/homework.php">Get HomeWork </a>
						</div>
			<div class="ult_div prim_div">
			<h2>ㅤGet<br>Homework</h2>
			...
			<div class="card flex2">
				...
				<h1>Get  Result
					...
					<p >To Get results click below
				</p>
				<a href="result/result.php">Get result </a>
							</div>
				<div class="ult_div prim_div">
				<h2>Get<br>Result</h2>
